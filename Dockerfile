...
RUN addgroup -S nginx &&\
    ...
    apk add --update-cache --no-cache git openssh curl 'luajit-dev>2.1' geoip-dev pcre-dev libxslt-dev gd-dev openssl-dev zlib-dev gcc make libc-dev linux-headers gnupg1 &&\
    rm -rf /var/cache/apk/*
